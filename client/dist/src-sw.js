  ...
  (s.n = (e) => {
    ...
    (() => {
      ...
      (0, s(796).precacheAndRoute)([
        { revision: "04e151942c314566e5ef26b2e953c9de", url: "bundle.js" },
        { revision: "d4d64ae6f2fdafac36b4d459d13775b5", url: "index.html" },
        { revision: "55000d38b02080fb4cbf975ce66bb3a4", url: "main.css" },
      ]);
      var h = new n({
        cacheName: "page-cache",
        plugins: [
          new c({ statuses: [0, 200] }),
          new o({ maxAgeSeconds: 2592e3 }),
        ],
      });
      t({ urls: ["/index.html", "/"], strategy: h }),
        i(function (e) {
        ...
        i(function (e) {
          ...
          plugins: [
            new c({ statuses: [0, 200] }),
            new o({ maxEntries: 60, maxAgeSeconds: 2592e3 }),
          ],
        })),
        i(function (e) {
          var t = e.request;
